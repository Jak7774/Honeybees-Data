...
def main():
    ...
    current_month = 12
    # Only run the function if the month is between October (10) and April (4)
    if current_month >= 10 or current_month <= 4:
        ...
        print("The function does not run between May and September.")
